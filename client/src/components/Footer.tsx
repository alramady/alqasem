...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a1628] pt-16 pb-8" role="contentinfo" aria-label={isAr ? "تذييل الموقع" : "Site footer"}>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              {instagram && (
                <a href={instagram} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#c8a45e]/20 transition-all" aria-label="Instagram">
                  <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                </a>
              )}
              {twitter && (
                <a href={twitter} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#c8a45e]/20 transition-all" aria-label="X (Twitter)">
                  <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
              )}
              {tiktok && (
                <a href={tiktok} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#c8a45e]/20 transition-all" aria-label="TikTok">
                  <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46V12.8a8.28 8.28 0 005.58 2.17V11.5a4.84 4.84 0 01-3.77-1.58V6.69z"/></svg>
                </a>
              )}
              {snapchat && (
                <a href={snapchat} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#c8a45e]/20 transition-all" aria-label="Snapchat">
                  <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12.959-.289.105-.06.21-.09.3-.09.12 0 .24.03.33.09.36.21.54.54.54.87 0 .6-.6 1.05-1.35 1.35-.15.06-.33.12-.51.18-.12.03-.24.06-.36.09-.21.06-.39.12-.54.21-.18.12-.33.3-.42.54-.06.18-.09.39-.09.6 0 .03.003.06.006.09.003.03.006.06.006.09.21.36.66.66 1.08.87.42.21.87.39 1.29.51.15.03.3.06.42.12.6.21 1.02.6 1.02 1.08 0 .12-.03.24-.09.36-.15.33-.51.6-1.05.78-.27.09-.57.15-.87.18-.15.015-.3.03-.45.06-.15.03-.3.09-.39.18-.12.12-.18.3-.21.48-.03.12-.03.24-.03.36 0 .12.015.24.03.36.015.09.03.18.03.27 0 .12-.03.24-.09.33-.09.12-.21.21-.36.27-.15.06-.33.09-.51.09-.12 0-.27-.015-.42-.045-.3-.06-.6-.18-.87-.3-.36-.15-.75-.3-1.2-.42-.3-.09-.6-.12-.9-.12-.21 0-.42.015-.63.06-.6.12-1.08.45-1.56.78-.48.33-.96.72-1.62.72s-1.14-.39-1.62-.72c-.48-.33-.96-.66-1.56-.78-.21-.045-.42-.06-.63-.06-.3 0-.6.03-.9.12-.45.12-.84.27-1.2.42-.27.12-.57.24-.87.3-.15.03-.3.045-.42.045-.18 0-.36-.03-.51-.09-.15-.06-.27-.15-.36-.27-.06-.09-.09-.21-.09-.33 0-.09.015-.18.03-.27.015-.12.03-.24.03-.36 0-.12 0-.24-.03-.36-.03-.18-.09-.36-.21-.48-.09-.09-.24-.15-.39-.18-.15-.03-.3-.045-.45-.06-.3-.03-.6-.09-.87-.18-.54-.18-.9-.45-1.05-.78-.06-.12-.09-.24-.09-.36 0-.48.42-.87 1.02-1.08.12-.06.27-.09.42-.12.42-.12.87-.3 1.29-.51.42-.21.87-.51 1.08-.87.003-.03.006-.06.006-.09.003-.03.006-.06.006-.09 0-.21-.03-.42-.09-.6-.09-.24-.24-.42-.42-.54-.15-.09-.33-.15-.54-.21-.12-.03-.24-.06-.36-.09-.18-.06-.36-.12-.51-.18-.75-.3-1.35-.75-1.35-1.35 0-.33.18-.66.54-.87.09-.06.21-.09.33-.09.09 0 .195.03.3.09.3.17.66.273.96.29.198 0 .326-.046.401-.091-.008-.165-.018-.33-.03-.51l-.003-.06c-.104-1.628-.23-3.654.3-4.847C7.86 1.069 11.216.793 12.206.793z"/></svg>
                </a>
              )}
              {linkedin && (
                <a href={linkedin} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#c8a45e]/20 transition-all" aria-label="LinkedIn">
                  <svg className="w-4 h-4 text-white/70" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
              )}
            </div>
          </div>
        ...
        {/* FAL License Badge */}
        {falNumber && (
          <div className="flex items-center justify-center gap-3 mb-6 py-3 px-4 bg-white/5 rounded-xl border border-white/10">
            <div className="w-8 h-8 rounded-lg bg-[#c8a45e]/20 flex items-center justify-center shrink-0">
              <svg className="w-4 h-4 text-[#c8a45e]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
            </div>
            <div className="text-center">
              <p className="text-white/40 text-[10px] uppercase tracking-wider">
                {isAr ? "مرخصة من الهيئة العامة للعقار" : "Licensed by REGA"}
              </p>
              <p className="text-[#c8a45e] font-bold text-sm" dir="ltr">
                {isAr ? `رخصة فال: ${falNumber}` : `Fal License: ${falNumber}`}
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            <p className="text-white/30 text-sm">
              {isAr
                ? `© جميع الحقوق محفوظة – شركة القاسم العقارية ${new Date().getFullYear()}.`
                : `© All Rights Reserved – Al-Qasim Real Estate ${new Date().getFullYear()}.`}
            </p>
